...
|--------------|---------|------------------|--------|-------|
| PHP 8.2      | Bullseye| dev| [![Test and publish 8.2](https://github.com/moodlehq/moodle-php-apache/actions/workflows/test_buildx_and_publish.yml/badge.svg?branch=master)](https://github.com/moodlehq/moodle-php-apache/actions/workflows/test_buildx_and_publish.yml)|8.2.0RC2, testing
